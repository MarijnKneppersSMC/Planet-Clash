...
export default class TitleScreen {
	...
	static draw() {
		...
		Renderer.drawText("Code by Marijn Kneppers", 15, Constants.screenDimensions.x / 2, 375, Color.grey, "center", "top");
		Renderer.drawText("Art by Twan Kneppers", 15, Constants.screenDimensions.x / 2, 400, Color.grey, "center", "top");
